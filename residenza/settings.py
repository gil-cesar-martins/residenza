...
WSGI_APPLICATION = 'residenza.wsgi.application'
...
EMAIL_HOST_USER = "no-reply@<digite-aqui-o-email>"
EMAIL_PORT = 587
EMAIL_USE_TSL = True
EMAIL_HOST_PASSWORD = '<digite aqui a senha>'
DEFAULT_FROM_EMAIL = '<digite aqui o email>'
